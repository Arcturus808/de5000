<script>
	...
	$: mainDetail =
		$lastMeasurement?.main_status === 'normal'
			? `${formatDisplayValue($lastMeasurement.main_val, $lastMeasurement.main_units)} ${$lastMeasurement.main_units}`
			: '----';

	$: secDetail =
		$lastMeasurement?.sec_status === 'normal'
			? `${formatDisplayValue($lastMeasurement.sec_val, $lastMeasurement.sec_units)} ${$lastMeasurement.sec_units}`
			: '----';
</script>
